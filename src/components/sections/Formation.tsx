...
const Formation: FunctionComponent<FormationProps> = ({ formations }) => {
  return (
    <div className="container pt-24 pb-14">
      ...
      <div className="mt-6">
        ...
        <div>
          ...
          <Link
            href="/formation/CATALOGUE-DES-FORMATIONS-EN-INTER-2025.pdf"
            target="_blank"
            rel="noopener noreferrer"
        ...
        {formations.map((formation, index) => (
          <div key={`formation${index}`}>
            ...
            <div>
              ...
              <p>
                <b>Formateur.trices: </b> {formation.trainers}
              </p>
            </div>
          </div>
        ))}
      ...
      <div className="mt-6 flex flex-col">
        ...
        <div className="flex flex-col-reverse xl:flex-row-reverse gap-6">
          ...
          <div className="xl:w-1/2 space-y-2">
            ...
            <ul>
              <li>290 € / jour</li> <li> 300 € / jour (selon la formation)</li>
            </ul>
