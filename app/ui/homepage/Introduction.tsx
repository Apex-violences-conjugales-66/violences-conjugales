  ...
  return (
    <SectionComponent>
      <div className="container flex flex-col relative gap-8 md:gap-0">
        ...
        <div className="w-full flex flex-col md:w-2/3 items-center md:items-start md:-mt-16 xl:-mt-32">
          ...
          <p>
            ...
            <br /> Notre approche met l&rsquo;accent sur la responsabilisation
            des individus, sans les victimiser.
            <br />
            <br />
